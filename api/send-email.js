        ...
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <div style="background: white; padding: 30px; border: 2px solid #232324; border-top: none; border-radius: 0 0 16px 16px;">
            ...
            <div style="text-align: center; margin: 30px 0;">
              <a href="https://thecreatorverse.xyz/?team-invite=${data?.inviteToken || ''}" style="background: #2D7FF9; color: white; padding: 16px 40px; border-radius: 12px; text-decoration: none; font-weight: bold; display: inline-block; font-size: 16px;">
            ...
            <p style="color: #999; font-size: 12px; margin-top: 10px; padding-top: 15px; border-top: 1px solid #eee;">
              Or copy this link: https://thecreatorverse.xyz/?team-invite=${data?.inviteToken || ''}
            </p>
          </div>
